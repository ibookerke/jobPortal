...
export default {
    ...
    name: "JobLocation",
    props: ['editorMode', 'currentJobLocation', 'currentJobLocationDetails'],
    data() {
        return {
            jobLocation: {
                address: null,
    ...
    created() {
        ...
        {
            this.jobLocation = this.currentJobLocation;
            let locationDetails = this.currentJobLocationDetails;
    ...
    watch: {
        jobLocation: {
            handler: function (value) {
                this.$emit('setJobLocation', value);
            },
            deep: true
        },
